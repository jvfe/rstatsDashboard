...
top_hashtags <- rstats_tweets %>% 
    ...
    mutate(
      number = formattable::color_bar("lightgray", formattable::proportion)(n),
      hashtag = stringr::str_glue('<a href="https://twitter.com/hashtag/{hashtags}" target="_blank">#{hashtags}</a>'),
    ) %>% 
